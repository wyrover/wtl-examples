...
class CMainFrame2 : 
  public CFrameWindowImpl<CMainFrame2, ATL::CWindow, CFrameWinTraits>, 
	public CUpdateUI<CMainFrame2>,
...
public:
  ...
  typedef  CFrameWindowImpl<CMainFrame2, ATL::CWindow, CFrameWinTraits> PARENT_FRAME_WINDOW_CLASS;
	...
	BEGIN_UPDATE_UI_MAP(CMainFrame2)
