...
//////////////////////////////////////////////////////////////////////////
// GetColor & WriteColor added by XuYu at 2007.05.23
//////////////////////////////////////////////////////////////////////////
COLORREF CIni::GetColor(LPCTSTR lpSection, LPCTSTR lpKey, COLORREF clrDefault)
{
    LPTSTR psz = __GetStringDynamic(lpSection, lpKey, _T(""));
    ...
    wchar_t* szValue = new wchar_t[10];
    memset(szValue, 0, 10);
...
BOOL CIni::WriteColor(LPCTSTR lpSection, LPCTSTR lpKey, COLORREF clr)
{
    return TRUE;
}
