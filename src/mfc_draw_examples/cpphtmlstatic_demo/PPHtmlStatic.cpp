...
//	SetWindowLong(GetSafeHwnd(), GWL_EXSTYLE, dwExStyles);
	...
	//RUS: Ïîëó÷àåì ñèñòåìíûé øðèôò ïî-óìîë÷àíèþ
	if (NULL == hFont)
	{
...
*/
	...
	//RUS: Ïîëîæåíèå îáëàñòè âûâîäà ïî îòíîøåíèþ ê êëèåíòñêèì êîîðäèíàòàì
...
void CPPHtmlStatic::RepaintWindow(HDC hDC /* = NULL */)
{
	...
	//RUS: Åñëè êîíòåêñò óñòðîéñòâà íå ïåðåäàâàëñÿ, òî ïîëó÷àåì åãî è óñòàíàâëèâàåì ïðèçíàê àâòîìàòè÷åñêîãî óäàëåíèÿ
	...
	//RUS: Ñîçäàåì êîíòåêñò óñòðîéñòâà â ïàìÿòè
	...
	//RUS: Êîïèðóåì ôîí ïîä òóëòèïîì â ïàìÿòü
	...
	//ENG: Free resources
	//RUS: Îñâîáîæäàåì çàäåéñòâîâàííûå ðåñóðñû
	...
	//RUS: Îñâîáîæäàåì êîíòåêñò óñòðîéñòâà åñëè ýòî íåîáõîäèìî
	if (bAutoReleaseDC)
